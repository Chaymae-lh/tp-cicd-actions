...
describe('add', () => {
  ...
  test('additionne avec un nombre négatif', () => { expect(add(-1, 5)).toBe(4); });
});
describe('multiply', () => {
  test('multiplie deux nombres', () => { expect(multiply(3, 4)).toBe(12); });
  test('multiplie par zéro', () => { expect(multiply(5, 0)).toBe(0); });
});
describe('factorial', () => {
